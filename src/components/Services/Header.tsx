  ...
  return (
      ...
      <div className="max-w-7xl w-full max-lg:flex-col flex items-center justify-center px-8">
        ...
        <div className="flex flex-col justify-center text-center gap-y-10" ref={textRef}>
          <h1 className={`text-[42px] max-md:text-[36px] max-sm:text-[32px] font-bold text-white transition-all duration-[1500ms] ${
          ...
          We pride ourselves on providing engaging digital marketing solutions.
          </p>
        </div>
      </div>
    </div>
