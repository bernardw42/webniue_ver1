...
import tab from "@/../public/blog/articles/pembelian-jasa/yes.webp";
    ...
    <div className={`relative w-full flex flex-col ${isMobileLandscape ? 'h-[540px]' : 'h-[50vh]'} justify-center items-center bg-[white] overflow-hidden`}>
        <div className="w-full lg:max-w-7xl mt-[150px] flex items-center justify-start max-lg:px-[8%]">
            ...
            <nav className="flex items-center space-x-2">
                ...
                <span className="text-gray-500 max-sm:max-w-[150px] truncate">Pentingnya Social Media Management untuk Kesuksesan Bisnis di Era Digital</span>
            </nav>
        </div>
        ...
        <div className="absolute top-[60%] max-[400px]:top-[62%] inset-0 flex justify-center items-start max-w-7xl mx-auto px-10 z-20">
            <div
                ref={headerRef}
            ...
            >
                ...
                Pentingnya Social Media Management untuk Kesuksesan Bisnis di Era Digital
                </h1>
            </div>
        </div>
    </div>
