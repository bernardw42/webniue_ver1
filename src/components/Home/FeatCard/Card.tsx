...
const Card: React.FC<CardProps> = ({ title, desc, image, className}) => {
  return (
    <div className={`flex flex-col justify-start gap-y-[30px] items-center max-w-[300px] min-h-[500px] px-10 ${className}`}>
      <Image src={image} alt="tes" className="h-[140px] w-auto" />
