      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="flex flex-col justify-between items-center px-5 py-2 pt-[150px] gap-y-[60px]">
            <li>
              <LinkWithLocale href="/aboutus" className="font-medium w-full text-white hover:text-gray-600 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>{t('NavBar.p1')}</LinkWithLocale>
            </li>
            <li>
              <LinkWithLocale href="/services" className="font-medium w-full text-white hover:text-gray-600 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>{t('NavBar.p2')}</LinkWithLocale>
            </li>
            <li>
            ...
            <div className='flex flex-wrap items-center font-medium gap-x-2 pr-[30px]'>
              ...
              <button className='font-medium px-1 py-3 flex items-center transition duration-150 ease-in-out drop-shadow-2xl focus:outline-none' onClick={() => setMobileNavOpen(false)}>
                <LanguageSwitcher lang="en" className="text-white">
                  <p className='text-[17px] text-white hover:text-gray-600'>EN</p>
                </LanguageSwitcher>
              </button>
              ...
              {/* ID button */}
              <button className='font-medium px-1 py-3 flex items-center transition duration-150 ease-in-out drop-shadow-2xl focus:outline-none' onClick={() => setMobileNavOpen(false)}>
                <LanguageSwitcher lang="id" className="text-white">
                  <p className='text-[17px] text-white hover:text-gray-600'>ID</p>
                </LanguageSwitcher>
              </button>
            </div>
          </ul>          
