...
export default function Header() {
  ...
  return (
      <div
        className="relative flex items-center justify-center h-screen w-auto bg-cover bg-center bg-fixed overflow-hidden z-20"
        style={{
      ...
      <div className="max-w-5xl w-full max-lg:flex-col flex items-center justify-center px-8">
        ...
        <div className="flex flex-col justify-center text-center gap-y-10" ref={textRef}>
          ...
          {t('workh.h2')} <br></br><span>{t('workh.h3')}</span>
          </p>
        </div>
      </div>
    </div>
